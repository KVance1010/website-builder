...
function Header() {
    ...
    return (
        <header className="d-flex justify-content-between align-items-center header_container">
            <h1 className="ms-5 logo_title"><img className="logo_img" src={logo}/> Aspiration Architects</h1>
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul className="navbar-nav">
                            <li className="nav-item">
                                <Link to="/login">
                                    <p className="nav-link active text-white fw-bold" aria-current="page">Login</p>
                                </Link>
                            </li>
                            <li className="nav-item">
                                <Link to="/projects">
